...
urlpatterns = [
    ...
    path('organizer/<int:event_id>/delete/', views.delete_event, name='delete_event'),

    # Admin event approval views
    path('admin/pending-events/', views.admin_pending_events, name='admin_pending_events'),
    path('admin/<int:event_id>/approve/', views.approve_event, name='approve_event'),
    path('admin/<int:event_id>/reject/', views.reject_event, name='reject_event'),

    # Student views
    path('student/dashboard/', views.student_dashboard, name='student_dashboard'),
    path('student/update-interests/', views.update_interests, name='update_interests'),
